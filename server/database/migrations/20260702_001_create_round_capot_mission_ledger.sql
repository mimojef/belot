...
-- Idempotency ledger for round-level capot mission progress.
...
CREATE TABLE IF NOT EXISTS round_capot_mission_ledger (
...
CREATE INDEX IF NOT EXISTS idx_round_capot_mission_ledger_room
  ON round_capot_mission_ledger(room_id);
