...
check('champion final result has tournament-specific title, score and prize/pending copy', activeRoomController.includes('Вие спечелихте турнира!') && activeRoomController.includes('Класирахте се на второ място!') && activeRoomController.includes('Наградата се обработва') && activeRoomController.includes('Награда: +'))
