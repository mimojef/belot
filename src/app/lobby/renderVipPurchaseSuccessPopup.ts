...
// Показва се САМО след server-confirmed paid VIP покупка (webhook settlement
// вече е минал — виж waitForPaidVipPurchase/handleStripePaymentSuccessReturn
// в main.ts). days/activeUntilLabel идват от РЕАЛНИЯ покупен пакет и
// РЕАЛНИЯ обновен /api/vip/status отговор — никога client-side изчислени.
