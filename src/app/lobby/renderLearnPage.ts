...
<article style="padding:${padding};max-width:${maxWidth};box-sizing:border-box;">
  ...
  <header style="margin-bottom:${isMobile ? '20px' : '30px'};">
    ...
    <p style="${pDimStyle}margin-bottom:0;">Белотът е една от най-обичаните карти игри в България — отборна, тактическа и достатъчно дълбока, за да ѝ се посветиш с години, но достатъчно достъпна, за да изиграеш първото си раздаване днес.</p>
    <p style="${pDimStyle}margin-bottom:0;margin-top:8px;">Тази страница е отправна точка за нов играч в Pika.bg. Тя не замества подробните правила, а обяснява основната идея на играта и накъде да продължиш, за да навлезеш по-дълбоко.</p>
  </header>
  ...
  <section id="kakvo" style="${sectionStyle}">
    ...
    <p style="${pStyle}">Белотът се играе с 32 карти между четирима души, разделени в два отбора по двама. Всяко раздаване минава през три етапа: наддаване, разиграване на осем ръце и изчисляване на резултата. Партиите продължават, докато някой отбор събере достатъчно точки, за да спечели.</p>
    <p style="${pStyle}margin-bottom:0;">За разлика от много карти игри, в белота печели не просто този с по-силни карти, а отборът, който по-добре чете ситуацията — какво е обявено, какво вече е изиграно и какво най-вероятно държи партньорът.</p>
  </section>
  ...
  <section id="purvi-stupki" style="${sectionStyle}">
    ...
    <p style="${pStyle}">В Pika.bg не се налага да чакаш трима приятели, за да седнеш на маса. Влизаш в лоби, избираш маса и играта се раздава веднага — ако липсва играч, мястото се заема временно от бот, докато не се включи истински човек.</p>
    ...
    <p style="${pStyle}margin-bottom:0;">Ако искаш пълните формални правила, преди или след да пробваш игра, виж <a href="/rules" style="${linkStyle}">Правила на белота</a>.</p>
  </section>
  ...
  <section id="tochki-vkratse" style="${sectionStyle}">
    ...
    <p style="${pStyle}">В края на раздаването точките от изиграните карти, анонсите и белота се сумират и превръщат в записан резултат. Партията продължава, докато някой отбор не достигне определен праг точки с решаващо предимство.</p>
