...
<article style="padding:${padding};max-width:${maxWidth};box-sizing:border-box;">
  ...
  <header style="margin-bottom:${isMobile ? '20px' : '30px'};">
    ...
    <p style="${pDimStyle}margin-bottom:0;">Тук сме събрали въпросите, които играчите ни задават най-често — за лобито, профила, ботовете на масата и виртуалните жълтици в Pika.bg. Ако не намериш отговор тук, можеш да се свържеш с екипа през <a href="/contact" style="${linkStyle}">страницата за контакти</a>.</p>
  </header>
  ...
  <section id="registracia" style="${sectionStyle}">
    ...
    <p style="${pStyle}">Публичните правила, съвети и информация за Pika.bg са достъпни без регистрация. За участие в реална игра е необходим профил, за да се пазят жълтиците, статистиката, рангът и историята на игрите ти.</p>
  ...
  <section id="gost" style="${sectionStyle}">
    <h2 style="${h2Style}">Достъп без регистрация</h2>

    <h3 style="${qFirstStyle}">Какво мога да разгледам без профил?</h3>
    <p style="${pStyle}">Правилата на белота, съветите и стратегиите, страниците за честна игра и всичко останало публично съдържание на Pika.bg са свободно достъпни без регистрация.</p>

    <h3 style="${qStyle}">Защо ми трябва профил, за да седна на маса?</h3>
    <p style="${pStyle}margin-bottom:0;">Профилът пази жълтиците, ранга, статистиката и историята на изиграните ти партии между отделните сесии — затова участието в реална игра изисква регистрация.</p>
  </section>
  ...
  <section id="jaltici" style="${sectionStyle}">
    ...
    <p style="${pStyle}">Жълтиците са виртуална игрова валута, валидна само вътре в Pika.bg. Те служат единствено като вход за сядане на маса и нямат стойност извън платформата.</p>

    <h3 style="${qStyle}">Мога ли да осребря жълтиците си или да ги изтегля като пари?</h3>
    <p style="${pStyle}">Не. Жълтиците не могат да бъдат осребрени, изтеглени или разменени за реални пари, награди или каквато и да е материална облага при никакви обстоятелства. Те съществуват единствено за игра в рамките на Pika.bg.</p>
  ...
  <section id="razdavane" style="${sectionStyle}">
    ...
    <p style="${pStyle}">Тестето се разбърква и раздава автоматично от сървъра на Pika.bg по случаен принцип, независимо от устройството или профила на играчите. Никой играч, вкл. администратори, не избира ръчно кой какви карти получава.</p>
