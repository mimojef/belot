...
<article style="padding:${padding};max-width:${maxWidth};box-sizing:border-box;">
  ...
  <header style="margin-bottom:${isMobile ? '20px' : '30px'};">
    ...
    <p style="${pDimStyle}margin-bottom:0;">Честната игра е основата, върху която стъпва цялата платформа Pika.bg. Тази страница обяснява как работи раздаването на карти, каква е ролята на ботовете и какво не се толерира при играта.</p>
  </header>
  ...
  <section id="sluchayno-razdavane" style="${sectionStyle}">
    ...
    <p style="${pStyle}">Всяко раздаване на карти в Pika.bg се извършва от сървъра на платформата по случаен принцип, независимо от профила, устройството или историята на играча. Тестето се разбърква наново преди всяко раздаване, а картите се разпределят поравно между четиримата участници на масата.</p>
