...
<article style="padding:${padding};max-width:${maxWidth};box-sizing:border-box;">
  ...
  <header style="margin-bottom:${isMobile ? '20px' : '30px'};">
    ...
    <p style="${pDimStyle}margin-bottom:0;">Pika.bg е онлайн платформа за игра на белот, създадена за хора, които обичат тази игра — независимо дали са играли с десетилетия на карти или тепърва я откриват.</p>
  </header>

  <section style="${sectionStyle}">
    <h2 style="${h2Style}">Развлекателна игра на белот</h2>
    <p style="${pStyle}">Целта на Pika.bg е проста: да направи белота лесно достъпен онлайн, без да е нужно да събираш трима приятели физически на маса. Влизаш, избираш маса според залога, който ти е удобен в жълтици, и играта започва — сама по себе си или с приятели в частна стая.</p>
